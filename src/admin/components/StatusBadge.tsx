...
> = {
  request: {
    ...
    no_match: { label: "No Match", className: "bg-slate-100 text-slate-700 border-slate-200" },
  ...
  match: {
    ...
    shown_to_renter: { label: "Shown to Renter", className: "bg-sky-50 text-sky-800 border-sky-200" },
    shown: { label: "Shown", className: "bg-sky-50 text-sky-800 border-sky-200" },
    dismissed: { label: "Dismissed", className: "bg-slate-100 text-slate-600 border-slate-200" },
    clicked_interested: { label: "Clicked Interested", className: "bg-primary/10 text-primary border-primary/20" },
    interested: { label: "Interested", className: "bg-primary/10 text-primary border-primary/20" },
    supplier_notified: { label: "Supplier Notified", className: "bg-amber-50 text-amber-800 border-amber-200" },
    supplier_declined: { label: "Supplier Declined", className: "bg-rose-50 text-rose-800 border-rose-200" },
    connected: { label: "Connected", className: "bg-indigo-50 text-indigo-800 border-indigo-200" },
    expired: { label: "Expired", className: "bg-slate-50 text-slate-500 border-slate-200" },
