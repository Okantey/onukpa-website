...
const ForAgents = () => {
  ...
  return (
    <section className="py-20 bg-slate-50 border-y border-slate-200" id="for-agents">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div className="animate-on-scroll">
            ...
            <p className="text-slate-600 text-sm md:text-base mb-5">
              We no longer take agent sign-ups through the website. Message the Onukpa bot,
              choose the agent path, and complete your profile in chat. You’ll get a secure link
              to submit listings when you’re ready.
            </p>
          ...
          <div className="animate-on-scroll">
            <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm">
              ...
              <p className="text-sm text-slate-700">
                The marketing site is for discovery only. All supplier accounts and property
                submissions run through the bot and your magic link — consistent, auditable, and
                aligned with how renters use Onukpa.
              </p>
            </div>
          </div>
        </div>
